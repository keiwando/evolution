...
public static class Mutation {
    ...
    public static T Mutate<T, E>(T chromosome, Mode mode) where T: IMutatable<E> {

        switch (mode) {
            case Mode.ChunkFlip: return MutateChunkFlip<T, E>(chromosome);
            case Mode.Global: return MutateGlobal<T, E>(chromosome);
            case Mode.Inversion: return MutateInversion<T, E>(chromosome);
