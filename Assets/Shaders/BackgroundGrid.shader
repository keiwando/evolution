    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float2 xDistFromGridLine = abs(i.gridPos - round(i.gridPos)) / 0.5;
                float pixelWidth = ddx(i.gridPos);
                float lerpT = 1.0 - smoothstep(0, GRID_LINE_PIXEL_WIDTH * pixelWidth, min(xDistFromGridLine.x, xDistFromGridLine.y));
